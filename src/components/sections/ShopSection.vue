        ...
        <template #columns>
            <div class="text-column">
                <p>Auto-entrepreneur spécialisé dans la communication, L'Esprit Brique propose des services sur mesure
                    incluant la
                    création de kits personnalisés en briques avec vos propres designs. Nous proposons également à la
                    vente
                    ou sur
                    demande des briques personnalisées. N'attendez plus et contactez nous pour soumettre votre demande !
                </p>
